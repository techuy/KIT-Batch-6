...
//this function will print "Rock" "Scissor" "Paper" based on random number from game() function
void computer(int num){
  switch (num) {
    case 0:
...
//this function will be taken over if the user lose or win the game
int gameover() {
  int input;
